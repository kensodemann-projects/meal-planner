...
const mealDate = shallowRef<string | undefined | null>(props.mealDate ?? null);
const mealType = shallowRef<MealType | undefined | null>(props.mealType ?? null);
const nutrition = ref<Nutrition | undefined>(props.mealItem?.nutrition);
const recipeId = shallowRef<string | undefined | null>(props.mealItem?.recipeId ?? null);
