...
export const TEST_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Chef-prepared harissa-spiced chicken with pearl couscous and roasted vegetables.',
    kind: 'prepared',
  ...
  },
  {
    ...
    description: 'Lean turkey meatloaf with a side of steamed green beans.',
    kind: 'prepared',
    sourceId: 'iir00305003lfkdj',
    category: 'Poultry',
    cuisine: 'American',
    difficulty: 'Easy',
    servings: 1,
  ...
  },
  {
    ...
    description: 'A typical restaurant cheeseburger platter with fries.',
    kind: 'prepared',
    sourceId: 'restaurant',
    category: 'Beef',
    cuisine: 'American',
